...
In this project, we aim to analyze the "Hot Hand Fallacy" in basketball using Bayesian inference. This file explains the variables we used.
...
### List of All Variables Examined
...
- **HOT_HAND_SHOT_STREAK3**: (See above)
